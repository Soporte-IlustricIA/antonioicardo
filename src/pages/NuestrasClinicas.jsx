...
export default function NuestrasClinicas() {
  return (
    <>
      ...
      <section className="page-hero nc-hero">
      ...
      <section style={{ background: 'var(--cream-2, #F2EBDC)', padding: '80px 0' }}>
        <div className="container-wide">
          <div className="maps-section" style={{ padding: '0', background: 'transparent' }}>
            <div className="maps-head" style={{ marginBottom: '40px', textAlign: 'center' }} data-reveal>
              <span className="eyebrow" style={{ display: 'block', marginBottom: '8px' }}>· Ubicaciones exactas</span>
              <h2 style={{ fontFamily: '"Cormorant Garamond", serif', fontWeight: 500, fontSize: 'clamp(32px, 4vw, 52px)', margin: 0, lineHeight: 1.05 }}>Mapas interactivos de <span className="it">nuestras clínicas</span></h2>
            </div>
            <div className="maps-grid" data-reveal data-delay="1">
              <div className="rounded-2xl overflow-hidden border border-[#E5DFD3] shadow-lg h-[380px]">
                <iframe
